...
class F1ExpertService:
    # Operation attribute name doubles as the operation name. Renaming this
    # to ask_f1_expert makes the LLM-facing tool name meaningful (the contrib
    # helper derives the tool name from the operation name verbatim).
