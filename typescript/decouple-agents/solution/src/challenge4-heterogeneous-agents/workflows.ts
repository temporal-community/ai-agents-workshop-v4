...
export async function triageAgentWorkflow(request: AgentRequest): Promise<string> {
  ...
  // Identical in shape to challenge 3's travel tool. The handler behind this
  // endpoint is a Python Worker running a Strands Agents SDK planner — the
  // orchestrator cannot tell, and does not need to.
