...
async function run(): Promise<void> {
  ...
  // The plugin belongs on the Client as well as the Worker: it propagates the
  // model Activity configuration and the agent trace context into the Workflow
  // through a Workflow start header.
